...
<span class="line"><span>└── main.ts //应用程序入口文件。它使用NestFactory用来创建 Nest 应用实例</span></span></code></pre></div><h2 id="_5、常见目录结构" tabindex="-1">5、常见目录结构 <a class="header-anchor" href="#_5、常见目录结构" aria-label="Permalink to &quot;5、常见目录结构&quot;">​</a></h2>`,25)),k(a,{style:{color:"rgb(36, 41, 47)","background-color":"rgb(244, 246, 248)"}},{default:E(()=>s[0]||(s[0]=[t("常见的 NestJS 项目结构可能如下所示，随项目的增长可以进行扩展和调整")])),_:1,__:[0]}),s[2]||(s[2]=i(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">src</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">/</span></span>
