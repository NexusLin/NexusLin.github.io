import{_ as n,c as l,ag as i,G as p,w as h,B as k,o as E,a as t}from"./chunks/framework.Bft4-MjQ.js";const C=JSON.parse('{"title":"NestJS-创建项目","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"src/node/nest/NestJS-创建项目.md","filePath":"src/node/nest/NestJS-创建项目.md"}'),e={name:"src/node/nest/NestJS-创建项目.md"};function r(d,s,g,y,c,F){const a=k("font");return E(),l("div",null,[s[1]||(s[1]=i(`<h1 id="nestjs-创建项目" tabindex="-1">NestJS-创建项目 <a class="header-anchor" href="#nestjs-创建项目" aria-label="Permalink to &quot;NestJS-创建项目&quot;">​</a></h1><h2 id="_1、node环境要求" tabindex="-1">1、Node环境要求 <a class="header-anchor" href="#_1、node环境要求" aria-label="Permalink to &quot;1、Node环境要求&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Done </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">in</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 28.58s.</span></span></code></pre></div><h3 id="nest失效问题" tabindex="-1">nest失效问题 <a class="header-anchor" href="#nest失效问题" aria-label="Permalink to &quot;nest失效问题&quot;">​</a></h3><p>我本地电脑win11 系统，安装yarn第二种方式的时候时候出现了下面这个提示</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;nest&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 不是内部或外部命令，也不是可运行的程序或批处理文件。</span></span></code></pre></div><p>这个时候我更换成为了临时安装</p><h2 id="_3、运行访问" tabindex="-1">3、运行访问 <a class="header-anchor" href="#_3、运行访问" aria-label="Permalink to &quot;3、运行访问&quot;">​</a></h2><p>采用临时运行时候的提示：</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//选择y</span></span>
...
<span class="line"><span>└── main.ts //应用程序入口文件。它使用NestFactory用来创建 Nest 应用实例</span></span></code></pre></div><h2 id="_5、常见目录结构" tabindex="-1">5、常见目录结构 <a class="header-anchor" href="#_5、常见目录结构" aria-label="Permalink to &quot;5、常见目录结构&quot;">​</a></h2>`,25)),p(a,{style:{color:"rgb(36, 41, 47)","background-color":"rgb(244, 246, 248)"}},{default:h(()=>s[0]||(s[0]=[t("常见的 NestJS 项目结构可能如下所示，随项目的增长可以进行扩展和调整")])),_:1}),s[2]||(s[2]=i(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">src</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">/</span></span>
