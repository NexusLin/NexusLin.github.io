...
<span class="line"><span>nvm install v20</span></span></code></pre></div><p>这里我选择的LTS长期支持偶数版本v20 新建一个index.js文件 打开cmd命令行界面 里面输出一个简单的信息</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>jsconsole.log(&quot;Hello World林太白&quot;);</span></span></code></pre></div><p><img src="`+i+'" alt="image.png"></p><p>到此，我们的第一个ndoe程序已经搭建好了</p>',33),r=[c];function d(h,m,_,g,u,b){return n(),a("div",null,r)}const k=s(t,[["render",d]]);export{j as __pageData,k as default};
