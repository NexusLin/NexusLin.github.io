import{_ as n,c as p,o as t,ag as e}from"./chunks/framework.CqxIsSM8.js";const s="/images/canvas-01.png",l="/images/canvas-02.png",u=JSON.parse('{"title":"canvas篇","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"src/note/graphic/canvas篇.md","filePath":"src/note/graphic/canvas篇.md","lastUpdated":1750672388000}'),c={name:"src/note/graphic/canvas篇.md"};function i(o,a,d,h,r,g){return t(),p("div",null,a[0]||(a[0]=[e('<h1 id="canvas篇" tabindex="-1">canvas篇 <a class="header-anchor" href="#canvas篇" aria-label="Permalink to &quot;canvas篇&quot;">​</a></h1><h2 id="_1、canvas认识" tabindex="-1">1、canvas认识 <a class="header-anchor" href="#_1、canvas认识" aria-label="Permalink to &quot;1、canvas认识&quot;">​</a></h2><p>canvas（画布）是什么，<code>&lt;canvas&gt;</code>是HTML5新增的元素，用于通过JavaScript绘制图形的元素。</p><p>允许开发者使用JavaScript（但是不仅限制于js）中的脚本来绘制图像，在页面上绘制图形、动画、游戏等多媒体元素，而无需依赖插件（如Flash）。</p><p>Canvas本身是一个矩形区域，可以通过HTML <code>&lt;canvas&gt;</code> 元素在页面中定义，然后通过JavaScript来控制其绘图内容。</p><p><code>&lt;canvas&gt;</code>最早由Apple引入Webkit,使用<code>&lt;canvas&gt;</code>标签时，建议要成对出现，不要使用自闭合形式。</p><h2 id="_2、主要特点和用途包括" tabindex="-1">2、主要特点和用途包括： <a class="header-anchor" href="#_2、主要特点和用途包括" aria-label="Permalink to &quot;2、主要特点和用途包括：&quot;">​</a></h2><p>canvas凭借强大的绘图API和灵活性，成为了Web开发中动态和交互式图形内容重要工具</p><p>如果说画笔是美术师手中最好的工具，那么canvas就是前端画家手中的画笔。</p><ol><li><strong>绘图功能</strong>：Canvas最主要的功能就是绘图，它为我们提供了绘制路径、填充颜色、渐变、图像、文本等的API，可以用于创建各种复杂的图形和动画效果。</li><li><strong>动态图形</strong>：Canvas是基于脚本控制的，因此能够实现各种动态、交互式的图形和动画，比如实时更新的数据可视化、动态图表等。</li><li><strong>游戏开发</strong>：Canvas在游戏开发中有广泛的应用，通过绘制图形和实现交互逻辑，可以创建简单到复杂的2D游戏。</li><li><strong>图形编辑</strong>：用于图像处理和编辑，如绘制工具、简单的图像滤镜等。</li><li><strong>跨平台支持</strong>：Canvas基于HTML5标准的，因此能够在支持HTML5的各种现代浏览器中运行，而不受特定操作系统或设备的限制。</li></ol><p>日常使用</p><p><img src="'+s+`" alt="image.png"></p><h2 id="_3、简单使用" tabindex="-1">3、简单使用： <a class="header-anchor" href="#_3、简单使用" aria-label="Permalink to &quot;3、简单使用：&quot;">​</a></h2><p>接下来我们就写一个简单的Canvas示例，在页面上绘制一个简单的矩形：</p><p>思路：</p><p>写一个canvas元素，然背后定义宽高</p><p>获取元素，绘制红色矩形</p><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
