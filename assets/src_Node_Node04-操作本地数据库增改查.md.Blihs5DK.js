import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.DvHWMJgD.js";const e="/images/node4-1.png",l="/images/node4-2.png",i="/images/node4-3.png",t="/images/node4-4.png",o="/images/node4-5.png",r="/images/node4-6.png",c="/images/node4-7.png",d="/images/node5-1.png",u="/images/node5-2.png",g="/images/node5-3.png",h="/images/node5-4.png",q="/images/node5-5.png",m="/images/node5-6.png",b="/images/node5-7.png",S=JSON.parse('{"title":"❤04 Node+Express操作数据库增删改查","description":"","frontmatter":{},"headers":[],"relativePath":"src/Node/Node04-操作本地数据库增改查.md","filePath":"src/Node/Node04-操作本地数据库增改查.md"}'),v={name:"src/Node/Node04-操作本地数据库增改查.md"},_=p(`<h1 id="❤04-node-express操作数据库增删改查" tabindex="-1">❤04 Node+Express操作数据库增删改查 <a class="header-anchor" href="#❤04-node-express操作数据库增删改查" aria-label="Permalink to &quot;❤04 Node+Express操作数据库增删改查&quot;">​</a></h1><h2 id="_1、认识接口-node-js-restful-api" tabindex="-1">1、认识接口(Node.js RESTful API) <a class="header-anchor" href="#_1、认识接口-node-js-restful-api" aria-label="Permalink to &quot;1、认识接口(Node.js RESTful API)&quot;">​</a></h2><p>接下来我们先认识一些前置知识,看看Node.js里面的RESTful API是什么，如何帮助我们实现接口的</p><p>以下为 REST 基本架构的四个方法：</p><ul><li><strong>GET</strong> - 用于获取数据</li><li><strong>PUT</strong> - 用于更新或添加数据</li><li><strong>DELETE</strong> - 用于删除数据</li><li><strong>POST</strong> - 用于添加数据</li></ul><p><code>注：get和delete是在路径中传递数据，而post和put可以在request body中传递数据</code></p><h2 id="_2、查询用户列表-api-user-get查询" tabindex="-1">2、查询用户列表 （/api/user--get查询 ） <a class="header-anchor" href="#_2、查询用户列表-api-user-get查询" aria-label="Permalink to &quot;2、查询用户列表 （/api/user--get查询 ）&quot;">​</a></h2><p>之前我们采用Node连接数据库并查询数据，现在我们使用本地的axios进行请求数据 本地进行调用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>js// 获取用户</span></span>
...
<span class="line"><span>    });</span></span>
<span class="line"><span>  });</span></span>
<span class="line"><span>});</span></span></code></pre></div><p>请求发现我们地址已经成为了 <code>http://localhost:8888/api/user/5</code> 刷新数据库，果然我们删除已经成功了！</p><p><img src="`+b+'" alt="image.png"></p><p>到这里我们已经实现了增删改查，接下来下一节就是插入一些额外针对我们的增删改查进行优化和处理。</p>',73),E=[_];function k(y,x,T,f,C,j){return a(),n("div",null,E)}const N=s(v,[["render",k]]);export{S as __pageData,N as default};
