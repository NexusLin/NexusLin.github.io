import{_ as a,c as n,o as p,ag as l}from"./chunks/framework.DnwzncJk.js";const i="/images/echarts-huan1.png",g=JSON.parse('{"title":"echarts环形图使用配置","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"src/note/echarts/echarts-环形图.md","filePath":"src/note/echarts/echarts-环形图.md","lastUpdated":1750413191000}'),e={name:"src/note/echarts/echarts-环形图.md"};function t(c,s,h,r,o,d){return p(),n("div",null,s[0]||(s[0]=[l('<h1 id="echarts环形图使用配置" tabindex="-1">echarts环形图使用配置 <a class="header-anchor" href="#echarts环形图使用配置" aria-label="Permalink to &quot;echarts环形图使用配置&quot;">​</a></h1><h2 id="_1、认识安装和使用" tabindex="-1">1、认识安装和使用 <a class="header-anchor" href="#_1、认识安装和使用" aria-label="Permalink to &quot;1、认识安装和使用&quot;">​</a></h2><h3 id="官网效果" tabindex="-1">官网效果 <a class="header-anchor" href="#官网效果" aria-label="Permalink to &quot;官网效果&quot;">​</a></h3><p><img src="'+i+`" alt="image.png" loading="lazy"></p><h2 id="_2、🍉-简单安装使用" tabindex="-1">2、🍉 简单安装使用 <a class="header-anchor" href="#_2、🍉-简单安装使用" aria-label="Permalink to &quot;2、🍉 简单安装使用&quot;">​</a></h2><p>先确保你安装的是Echarts5，否则的化安装一下</p><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yarn add echarts</span></span></code></pre></div><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 结构部分</span></span>
