import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.DvHWMJgD.js";const g=JSON.parse('{"title":"❤ axios请求和Mock使用Vue3+vite（Vue3系统篇三）","description":"","frontmatter":{},"headers":[],"relativePath":"src/Vue/04-axios和Mock.md","filePath":"src/Vue/04-axios和Mock.md"}'),e={name:"src/Vue/04-axios和Mock.md"},l=p(`<h1 id="❤-axios请求和mock使用vue3-vite-vue3系统篇三" tabindex="-1">❤ axios请求和Mock使用Vue3+vite（Vue3系统篇三） <a class="header-anchor" href="#❤-axios请求和mock使用vue3-vite-vue3系统篇三" aria-label="Permalink to &quot;❤ axios请求和Mock使用Vue3+vite（Vue3系统篇三）&quot;">​</a></h1><h2 id="_1、打包环境" tabindex="-1">1、打包环境 <a class="header-anchor" href="#_1、打包环境" aria-label="Permalink to &quot;1、打包环境&quot;">​</a></h2><p>直接<code>yarn build</code> 会发现给我们提示了很多报错</p><p><img src="https://cdn.nlark.com/yuque/0/2024/webp/22435914/1726123994465-d7c32c59-3065-403b-8eed-41b509938ae9.webp" alt=""></p><h4 id="更改tsconfig-json文件夹下compileroptions" tabindex="-1">更改tsconfig.json文件夹下compilerOptions <a class="header-anchor" href="#更改tsconfig-json文件夹下compileroptions" aria-label="Permalink to &quot;更改tsconfig.json文件夹下compilerOptions&quot;">​</a></h4><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>js</span></span>
