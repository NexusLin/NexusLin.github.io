import{_ as a,c as n,ag as p,o as l}from"./chunks/framework.Bft4-MjQ.js";const k=JSON.parse('{"title":"echarts环形图使用配置","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"src/echarts/echarts环形图.md","filePath":"src/echarts/echarts环形图.md"}'),i={name:"src/echarts/echarts环形图.md"};function e(t,s,c,h,r,o){return l(),n("div",null,s[0]||(s[0]=[p(`<h1 id="echarts环形图使用配置" tabindex="-1">echarts环形图使用配置 <a class="header-anchor" href="#echarts环形图使用配置" aria-label="Permalink to &quot;echarts环形图使用配置&quot;">​</a></h1><p>林太白</p><h2 id="_1、认识安装和使用" tabindex="-1">1、认识安装和使用 <a class="header-anchor" href="#_1、认识安装和使用" aria-label="Permalink to &quot;1、认识安装和使用&quot;">​</a></h2><h3 id="官网效果" tabindex="-1">官网效果 <a class="header-anchor" href="#官网效果" aria-label="Permalink to &quot;官网效果&quot;">​</a></h3><p><img src="https://cdn.nlark.com/yuque/0/2024/webp/22435914/1727575665758-3e999548-6bc0-4519-89b3-462822d39ff9.webp" alt=""></p><h2 id="_2、🍉-简单安装使用" tabindex="-1">2、🍉 简单安装使用 <a class="header-anchor" href="#_2、🍉-简单安装使用" aria-label="Permalink to &quot;2、🍉 简单安装使用&quot;">​</a></h2><p>先确保你安装的是Echarts5，否则的化安装一下</p><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yarn add echarts</span></span></code></pre></div><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 结构部分</span></span>
...
<span class="line"><span>      color: &#39;inherit&#39; // 保持原有颜色</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>},</span></span></code></pre></div>`,20)]))}const g=a(i,[["render",e]]);export{k as __pageData,g as default};
