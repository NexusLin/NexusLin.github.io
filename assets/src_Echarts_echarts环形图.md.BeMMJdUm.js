import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.DvHWMJgD.js";const m=JSON.parse('{"title":"echarts南丁格尔玫瑰图（使用以及南丁格尔玫瑰图详细配置）","description":"","frontmatter":{},"headers":[],"relativePath":"src/Echarts/echarts环形图.md","filePath":"src/Echarts/echarts环形图.md"}'),e={name:"src/Echarts/echarts环形图.md"},l=p(`<h1 id="echarts南丁格尔玫瑰图-使用以及南丁格尔玫瑰图详细配置" tabindex="-1">echarts南丁格尔玫瑰图（使用以及南丁格尔玫瑰图详细配置） <a class="header-anchor" href="#echarts南丁格尔玫瑰图-使用以及南丁格尔玫瑰图详细配置" aria-label="Permalink to &quot;echarts南丁格尔玫瑰图（使用以及南丁格尔玫瑰图详细配置）&quot;">​</a></h1><h2 id="_1、认识安装和使用" tabindex="-1">1、认识安装和使用 <a class="header-anchor" href="#_1、认识安装和使用" aria-label="Permalink to &quot;1、认识安装和使用&quot;">​</a></h2><p>🍉</p><h3 id="官网效果" tabindex="-1">官网效果 <a class="header-anchor" href="#官网效果" aria-label="Permalink to &quot;官网效果&quot;">​</a></h3><p><img src="https://cdn.nlark.com/yuque/0/2024/webp/22435914/1727575665758-3e999548-6bc0-4519-89b3-462822d39ff9.webp" alt=""></p><h2 id="_2、🍉-简单安装使用" tabindex="-1">2、🍉 简单安装使用 <a class="header-anchor" href="#_2、🍉-简单安装使用" aria-label="Permalink to &quot;2、🍉 简单安装使用&quot;">​</a></h2><p>先确保你安装的是Echarts5，否则的化安装一下</p><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yarn add echarts</span></span></code></pre></div><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>复制代码// 结构部分</span></span>
...
<span class="line"><span>});</span></span></code></pre></div><p>展示一下官方给我们的默认设置</p><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>option = {</span></span>
...
<span class="line"><span>      color: &#39;inherit&#39; // 保持原有颜色</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>},</span></span></code></pre></div>`,20),i=[l];function c(t,o,r,h,d,u){return n(),a("div",null,i)}const g=s(e,[["render",c]]);export{m as __pageData,g as default};
